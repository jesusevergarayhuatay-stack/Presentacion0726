...
.tile.feat .ghost{font-size:216px;top:-48px}
...
.tile.feat .ttitle{font-size:26px;line-height:1.22;margin-top:14px}
...
.tile.feat .tdesc{font-size:13px;color:var(--mut);line-height:1.55;margin-top:14px;position:relative;z-index:1;max-width:92%;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;transform:translateZ(20px)}
...
DOCS.forEach((d,i)=>{
  ...
  t.className='tile'+(feat?' feat':'')+' rise';t.dataset.i=i;t.style.animationDelay=(.62+i*.1)+'s';
